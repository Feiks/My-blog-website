package com.firstspring.blog.controllers;

import com.firstspring.blog.models.Post;
import com.firstspring.blog.repo.PostRepository;
...
public class BlogController {
    ...
    public  String blogPostUpdate(@PathVariable(value = "id") long id,@RequestParam String title,@RequestParam String anonce,@RequestParam String full_text, Model model){
